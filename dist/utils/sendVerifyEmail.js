...
const sendVerificationEmail = async (email, uniqueString) => {
    ...
    const mailOption = {
      ...
      <div style="width: 600px; padding: 20px 8%; text-align: center; background-color: #fff; border-radius: 12px; color: #333;">
          ...
          <p><p>Verify your email address to complete the signup and login your account.</p><p>This link <b>expires in 60 Minutes</b>.</p><p>Press <a href=${currentUrl + "/user/verify/" + email + "/" + uniqueString}> here</a> to proceed</p>
      </div>
  </div>`,
    };
